...
public class tab15 extends javax.swing.JFrame {
    ...
    int tneg;
    public tab15(String nom1, String nom2, int iabr, int df){
        initComponents();
        ...
        if (nom2.equalsIgnoreCase("iaai")){
            ...
            mec.getTabInfo(13, df, this, tlab, esplab, timer, IAiru, kuro.getText(), shiro.getText());
            ...
            mec.getTabInfo(13, diff, this, tlab, esplab, timer, IAiru, kuro.getText(), shiro.getText());
            if (!IAiru){
                mec.stp(df);
